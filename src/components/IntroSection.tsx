...
const IntroSection = () => {
  return (
    <section className="p-4 sm:p-6 md:p-10 lg:p-20 w-[100vw] bg-[#FF9770] text-gray-900" aria-label='Introduction Section'>
      <div className="grid grid-cols-1 lg:grid-cols-3 lg:grid-flow-col lg:items-center lg:text-right text-center gap-6 max-w-7xl mx-auto">
        <div className="p-4 sm:p-6 md:p-8 lg:p-10 flex flex-col lg:col-span-2 lg:justify-center">
          ...
          <p className="font-light text-lg sm:text-xl md:text-2xl">
            ...
            seamless design. Explore my work to see how I can bring your vision
            to life.
          </p>
          <div className="flex justify-center lg:justify-end items-center gap-4 sm:gap-6 md:gap-10 m-4 md:m-5">
            <LinkButton icon={SiReact} href="/" text="Projects" />
