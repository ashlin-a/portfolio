...
import { FaFolder, FaBlog, FaEnvelope, FaBars, FaTimes } from 'react-icons/fa';
  ...
  return (
    <header className="bg-[#FF9770] text-gray-900 sticky top-0 z-20">
      ...
      >
        ...
        >
          <LinkButton href="/" text="Projects" icon={FaFolder} />
          <LinkButton href="/" text="Blog" icon={FaBlog} />
          <LinkButton href="/" text="Contact Me" icon={FaEnvelope} />
        </div>
      </nav>
    </header>
  );
